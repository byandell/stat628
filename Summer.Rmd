...
**Weekly Schedule:**
Each week will concern a different complex data project. In the case of a very complex big data project for the entire course, each week will focus on different aspect of the project. Meetings will include when possible visits by collaborators knowledgeable with the problem.
